...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-9">
                <h3>Trang In</h3><a href="../../../index.php" class="btn btn-outline-info mb-3">Trang chủ <i class="fa-solid fa-house"></i></a>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($ddh['tttt_ma'] == 4):?>
                                    ...
                                    <?php else: ?>
                                        <a href="print.php" class="btn btn-primary">In<i class="fa-regular fa-pen-to-square"></i></a>
                                <?php endif;?>
                                <!-- gửi bằng đường GET -->
