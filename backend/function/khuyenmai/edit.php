        ...
        <div class="row">
            ...
            <div class="col-9">
                ...
                <form name="frmThemMoi" id="frmThemMoi" method="post" action="">
                    ...
                    Từ ngày: <input type="date" name="km_tungay" value="<?= $data_array['km_tungay'] ?>" class="form-control" /><br />
                    Đến ngày: <input type="date" name="km_denngay" value="<?= $data_array['km_denngay'] ?>" class="form-control" /><br />
